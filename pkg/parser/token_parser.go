...
func (p *TokenParser) Parse(filename, content string) (*ast.ScopeTree, error) {
	// Initialize the tree
...
func (p *TokenParser) parseTopLevel() error {
...
func (p *TokenParser) parsePreprocessor() error {
	start := p.current
	p.advance() // consume '#'
...
func (p *TokenParser) parseDefine(start int) error {
...
func (p *TokenParser) parseOtherPreprocessor(start int) error {
...
func (p *TokenParser) resolveDefine(name string) string {
...
func (p *TokenParser) resolveDefineRecursive(name string, visited map[string]bool) string {
...
func (p *TokenParser) parseDoxygenComment(content string) *ast.DoxygenComment {
...
func (p *TokenParser) parseTemplate() error {
	start := p.current
...
func (p *TokenParser) parseTemplatedEntity(templateStart int, templateParams string) error {
	if p.isAtEnd() {
...
func (p *TokenParser) parseNamespace() error {
	start := p.current
...
func (p *TokenParser) parseTemplatedClass(templateStart int, templateParams string) error {
...
func (p *TokenParser) parseTemplatedStruct(templateStart int, templateParams string) error {
...
func (p *TokenParser) parseTemplatedUsing(templateStart int, templateParams string) error {
...
func (p *TokenParser) parseTemplatedFunction(templateStart int, templateParams string) error {
...
func (p *TokenParser) parseEnum() error {
	start := p.current
...
func (p *TokenParser) parseTypedef() error {
	start := p.current
...
func (p *TokenParser) parseUsing() error {
	start := p.current
	p.advance() // consume 'using'
...
func (p *TokenParser) parseUsingNamespace(start int) error {
	p.advance() // consume 'namespace'
...
func (p *TokenParser) parseAccessSpecifier() error {
	start := p.current
...
func (p *TokenParser) parseCloseBrace() error {
	p.advance() // consume '}'
...
func (p *TokenParser) parseFunctionOrVariable() error {
...
func (p *TokenParser) parseFunction() error {
	start := p.current
...
func (p *TokenParser) parseVariable() error {
	start := p.current
...
func (p *TokenParser) isAtEnd() bool {
...
func (p *TokenParser) previous() Token {
	if p.current <= 0 {
		return Token{Type: TokenEOF}
	}
...
func (p *TokenParser) match(types ...TokenType) bool {
...
func (p *TokenParser) check(tokenType TokenType) bool {
	if p.isAtEnd() {
		return false
	}
...
func (p *TokenParser) skipWhitespaceAndNewlines() {
	for !p.isAtEnd() && (p.peek().Type == TokenWhitespace || p.peek().Type == TokenNewline) {
		p.advance()
	}
}
...
func (p *TokenParser) skipSpecifiers() {
...
func (p *TokenParser) isFunction() bool {
	saved := p.current
...
func (p *TokenParser) parseFunctionSignature() (signature string, name string, isMethod bool, err error) {
...
func (p *TokenParser) parseInheritance() string {
...
func (p *TokenParser) parseType() string {
...
func (p *TokenParser) getCurrentScope() *ast.Entity {
...
func (p *TokenParser) getCurrentAccessLevel() ast.AccessLevel {
	if len(p.accessStack) == 0 {
...
func (p *TokenParser) isInsideClass() bool {
...
func (p *TokenParser) buildFullName(name string) string {
	scope := p.getCurrentScope()
...
func (p *TokenParser) addEntity(entity *ast.Entity) {
...
func (p *TokenParser) enterScope(entity *ast.Entity) {
	p.scopeStack = append(p.scopeStack, entity)
}

// exitScope exits the current scope
func (p *TokenParser) exitScope() {
...
func (p *TokenParser) getRangeFromTokens(start, end int) ast.Range {
...
func (p *TokenParser) parseClassOrStructWithMacro(entityType ast.EntityType) error {
	start := p.current
